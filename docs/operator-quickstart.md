# Operator Quickstart — Community Mission Operations Support

Shortest path from clone to a verified local dry-run for **ISIC 9900** (`cloud-itonami-isic-9900`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9900.git
cd cloud-itonami-isic-9900
```
...
- Blueprint governor key: `mission-operations-governor`
- Likely source path: `missionops.governor.cljc`
